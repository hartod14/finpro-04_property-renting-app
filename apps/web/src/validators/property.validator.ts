  ...
  rooms: Yup.array()
    .of(
      Yup.object().shape({
        ...
        base_price: Yup.number().required('Base price is required').positive('Price must be positive'),
        description: Yup.string().nullable(),
        capacity: Yup.number().required('Capacity is required').positive('Capacity must be positive').integer('Capacity must be an integer'),
        size: Yup.number().required('Size is required').positive('Size must be positive'),
        total_room: Yup.number().required('Total room is required').positive('Total room must be positive').integer('Total room must be an integer'),
        images: Yup.array()
